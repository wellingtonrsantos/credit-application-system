...
class CustomerResourceIT {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Wellington"))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("wel@email.com"))
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("WellingtonUpdate"))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua Test Updated"))
            .andDo(MockMvcResultHandlers.print())
    }
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "WellingtonUpdate",
        lastName: String = "SantosUpdate",
        income: BigDecimal = BigDecimal.valueOf(5000.0),
        zipCode: String = "45656",
        street: String = "Rua Test Updated"
